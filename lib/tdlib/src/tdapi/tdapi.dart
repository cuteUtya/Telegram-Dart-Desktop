...
final Map<String, TdObject Function(Map<String, dynamic>)> allObjects = {
  ...
  'textEntityTypeMediaTimestamp': (d) =>
      TextEntityTypeMediaTimestamp.fromJson(d),
  ...
  'chatActionWatchingAnimations': (d) =>
      ChatActionWatchingAnimations.fromJson(d),
  ...
  'groupCallVideoQualityThumbnail': (d) =>
      GroupCallVideoQualityThumbnail.fromJson(d),
  ...
  'groupCallParticipantVideoInfo': (d) =>
      GroupCallParticipantVideoInfo.fromJson(d),
  ...
  'backgroundFillFreeformGradient': (d) =>
      BackgroundFillFreeformGradient.fromJson(d),
  ...
  'checkStickerSetNameResultNameInvalid': (d) =>
      CheckStickerSetNameResultNameInvalid.fromJson(d),
  'checkStickerSetNameResultNameOccupied': (d) =>
      CheckStickerSetNameResultNameOccupied.fromJson(d),
  ...
  'pushMessageContentChatSetTheme': (d) =>
      PushMessageContentChatSetTheme.fromJson(d),
  ...
  'internalLinkTypeActiveSessions': (d) =>
      InternalLinkTypeActiveSessions.fromJson(d),
  'internalLinkTypeAuthenticationCode': (d) =>
      InternalLinkTypeAuthenticationCode.fromJson(d),
  ...
  'internalLinkTypeBotStartInGroup': (d) =>
      InternalLinkTypeBotStartInGroup.fromJson(d),
  'internalLinkTypeChangePhoneNumber': (d) =>
      InternalLinkTypeChangePhoneNumber.fromJson(d),
  'internalLinkTypeChatInvite': (d) => InternalLinkTypeChatInvite.fromJson(d),
  'internalLinkTypeFilterSettings': (d) =>
      InternalLinkTypeFilterSettings.fromJson(d),
  'internalLinkTypeGame': (d) => InternalLinkTypeGame.fromJson(d),
  'internalLinkTypeLanguagePack': (d) =>
      InternalLinkTypeLanguagePack.fromJson(d),
  'internalLinkTypeMessage': (d) => InternalLinkTypeMessage.fromJson(d),
  'internalLinkTypeMessageDraft': (d) =>
      InternalLinkTypeMessageDraft.fromJson(d),
  'internalLinkTypePassportDataRequest': (d) =>
      InternalLinkTypePassportDataRequest.fromJson(d),
  'internalLinkTypePhoneNumberConfirmation': (d) =>
      InternalLinkTypePhoneNumberConfirmation.fromJson(d),
  ...
  'internalLinkTypeQrCodeAuthentication': (d) =>
      InternalLinkTypeQrCodeAuthentication.fromJson(d),
  ...
  'internalLinkTypeThemeSettings': (d) =>
  ...
  'suggestedActionCheckPassword': (d) =>
      SuggestedActionCheckPassword.fromJson(d),
  ...
  'botCommandScopeAllPrivateChats': (d) =>
      BotCommandScopeAllPrivateChats.fromJson(d),
  'botCommandScopeAllGroupChats': (d) =>
      BotCommandScopeAllGroupChats.fromJson(d),
  'botCommandScopeAllChatAdministrators': (d) =>
      BotCommandScopeAllChatAdministrators.fromJson(d),
  'botCommandScopeChat': (d) => BotCommandScopeChat.fromJson(d),
  'botCommandScopeChatAdministrators': (d) =>
      BotCommandScopeChatAdministrators.fromJson(d),
  ...
  'updateAnimatedEmojiMessageClicked': (d) =>
      UpdateAnimatedEmojiMessageClicked.fromJson(d),
