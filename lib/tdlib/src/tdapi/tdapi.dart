...
part 'functions/set_message_reaction.dart';
...
final Map<String, TdObject Function(Map<String, dynamic>)> allObjects = {
    ...
    'thumbnailFormatWebm': (d) => ThumbnailFormatWebm.fromJson(d),
    ...
    'stickerType': (d) => StickerType.fromJson(d),
    'stickerTypeStatic': (d) => StickerTypeStatic.fromJson(d),
    'stickerTypeAnimated': (d) => StickerTypeAnimated.fromJson(d),
    'stickerTypeVideo': (d) => StickerTypeVideo.fromJson(d),
    'stickerTypeMask': (d) => StickerTypeMask.fromJson(d),
    ...
    'botCommands': (d) => BotCommands.fromJson(d),
    ...
    'messageForwardOriginMessageImport': (d) => MessageForwardOriginMessageImport.fromJson(d),
    'messageForwardInfo': (d) => MessageForwardInfo.fromJson(d),
    'messageReplyInfo': (d) => MessageReplyInfo.fromJson(d),
    'messageReaction': (d) => MessageReaction.fromJson(d),
    'messageInteractionInfo': (d) => MessageInteractionInfo.fromJson(d),
    'unreadReaction': (d) => UnreadReaction.fromJson(d),
    ...
    'paymentFormTheme': (d) => PaymentFormTheme.fromJson(d),
    ...
    'messageInviteVideoChatParticipants': (d) => MessageInviteVideoChatParticipants.fromJson(d),
    ...
    'messageChatSetTheme': (d) => MessageChatSetTheme.fromJson(d),
    ...
    'textEntityTypeMediaTimestamp': (d) => TextEntityTypeMediaTimestamp.fromJson(d),
    ...
    'searchMessagesFilterUnreadReaction': (d) => SearchMessagesFilterUnreadReaction.fromJson(d),
    ...
    'chatActionChoosingSticker': (d) => ChatActionChoosingSticker.fromJson(d),
    ...
    'chatActionWatchingAnimations': (d) => ChatActionWatchingAnimations.fromJson(d),
    ...
    'groupCallVideoQuality': (d) => GroupCallVideoQuality.fromJson(d),
    'groupCallVideoQualityThumbnail': (d) => GroupCallVideoQualityThumbnail.fromJson(d),
    'groupCallVideoQualityMedium': (d) => GroupCallVideoQualityMedium.fromJson(d),
    'groupCallVideoQualityFull': (d) => GroupCallVideoQualityFull.fromJson(d),
    'groupCallRecentSpeaker': (d) => GroupCallRecentSpeaker.fromJson(d),
    'groupCall': (d) => GroupCall.fromJson(d),
    'groupCallVideoSourceGroup': (d) => GroupCallVideoSourceGroup.fromJson(d),
    'groupCallParticipantVideoInfo': (d) => GroupCallParticipantVideoInfo.fromJson(d),
    ...
    'addedReaction': (d) => AddedReaction.fromJson(d),
    'addedReactions': (d) => AddedReactions.fromJson(d),
    'availableReactions': (d) => AvailableReactions.fromJson(d),
    'reaction': (d) => Reaction.fromJson(d),
    ...
    'chatEventMemberJoinedByInviteLink': (d) => ChatEventMemberJoinedByInviteLink.fromJson(d),
    'chatEventMemberJoinedByRequest': (d) => ChatEventMemberJoinedByRequest.fromJson(d),
    ...
    'chatEventAvailableReactionsChanged': (d) => ChatEventAvailableReactionsChanged.fromJson(d),
    ...
    'backgroundFillFreeformGradient': (d) => BackgroundFillFreeformGradient.fromJson(d),
    ...
    'themeSettings': (d) => ThemeSettings.fromJson(d),
    'chatTheme': (d) => ChatTheme.fromJson(d),
    ...
    'checkStickerSetNameResult': (d) => CheckStickerSetNameResult.fromJson(d),
    'checkStickerSetNameResultOk': (d) => CheckStickerSetNameResultOk.fromJson(d),
    'checkStickerSetNameResultNameInvalid': (d) => CheckStickerSetNameResultNameInvalid.fromJson(d),
    'checkStickerSetNameResultNameOccupied': (d) => CheckStickerSetNameResultNameOccupied.fromJson(d),
    'resetPasswordResult': (d) => ResetPasswordResult.fromJson(d),
    'resetPasswordResultOk': (d) => ResetPasswordResultOk.fromJson(d),
    'resetPasswordResultPending': (d) => ResetPasswordResultPending.fromJson(d),
    'resetPasswordResultDeclined': (d) => ResetPasswordResultDeclined.fromJson(d),
    ...
    'pushMessageContentChatSetTheme': (d) => PushMessageContentChatSetTheme.fromJson(d),
    ...
    'pushMessageContentChatJoinByRequest': (d) => PushMessageContentChatJoinByRequest.fromJson(d),
    ...
    'internalLinkType': (d) => InternalLinkType.fromJson(d),
    'internalLinkTypeActiveSessions': (d) => InternalLinkTypeActiveSessions.fromJson(d),
    'internalLinkTypeAuthenticationCode': (d) => InternalLinkTypeAuthenticationCode.fromJson(d),
    'internalLinkTypeBackground': (d) => InternalLinkTypeBackground.fromJson(d),
    'internalLinkTypeBotStart': (d) => InternalLinkTypeBotStart.fromJson(d),
    'internalLinkTypeBotStartInGroup': (d) => InternalLinkTypeBotStartInGroup.fromJson(d),
    'internalLinkTypeChangePhoneNumber': (d) => InternalLinkTypeChangePhoneNumber.fromJson(d),
    'internalLinkTypeChatInvite': (d) => InternalLinkTypeChatInvite.fromJson(d),
    'internalLinkTypeFilterSettings': (d) => InternalLinkTypeFilterSettings.fromJson(d),
    'internalLinkTypeGame': (d) => InternalLinkTypeGame.fromJson(d),
    'internalLinkTypeLanguagePack': (d) => InternalLinkTypeLanguagePack.fromJson(d),
    'internalLinkTypeMessage': (d) => InternalLinkTypeMessage.fromJson(d),
    'internalLinkTypeMessageDraft': (d) => InternalLinkTypeMessageDraft.fromJson(d),
    'internalLinkTypePassportDataRequest': (d) => InternalLinkTypePassportDataRequest.fromJson(d),
    'internalLinkTypePhoneNumberConfirmation': (d) => InternalLinkTypePhoneNumberConfirmation.fromJson(d),
    'internalLinkTypeProxy': (d) => InternalLinkTypeProxy.fromJson(d),
    'internalLinkTypePublicChat': (d) => InternalLinkTypePublicChat.fromJson(d),
    'internalLinkTypeQrCodeAuthentication': (d) => InternalLinkTypeQrCodeAuthentication.fromJson(d),
    'internalLinkTypeSettings': (d) => InternalLinkTypeSettings.fromJson(d),
    'internalLinkTypeStickerSet': (d) => InternalLinkTypeStickerSet.fromJson(d),
    'internalLinkTypeTheme': (d) => InternalLinkTypeTheme.fromJson(d),
    'internalLinkTypeThemeSettings': (d) => InternalLinkTypeThemeSettings.fromJson(d),
    'internalLinkTypeUnknownDeepLink': (d) => InternalLinkTypeUnknownDeepLink.fromJson(d),
    'internalLinkTypeUnsupportedProxy': (d) => InternalLinkTypeUnsupportedProxy.fromJson(d),
    ...
    'botCommandScope': (d) => BotCommandScope.fromJson(d),
    'botCommandScopeDefault': (d) => BotCommandScopeDefault.fromJson(d),
    'botCommandScopeAllPrivateChats': (d) => BotCommandScopeAllPrivateChats.fromJson(d),
    'botCommandScopeAllGroupChats': (d) => BotCommandScopeAllGroupChats.fromJson(d),
    'botCommandScopeAllChatAdministrators': (d) => BotCommandScopeAllChatAdministrators.fromJson(d),
    'botCommandScopeChat': (d) => BotCommandScopeChat.fromJson(d),
    'botCommandScopeChatAdministrators': (d) => BotCommandScopeChatAdministrators.fromJson(d),
    'botCommandScopeChatMember': (d) => BotCommandScopeChatMember.fromJson(d),
    ...
    'updateMessageUnreadReactions': (d) => UpdateMessageUnreadReactions.fromJson(d),
    ...
    'updateChatAvailableReactions': (d) => UpdateChatAvailableReactions.fromJson(d),
    ...
    'updateChatUnreadReactionCount': (d) => UpdateChatUnreadReactionCount.fromJson(d),
    ...
    'updateChatThemes': (d) => UpdateChatThemes.fromJson(d),
    ...
    'updateReactions': (d) => UpdateReactions.fromJson(d),
    'updateDiceEmojis': (d) => UpdateDiceEmojis.fromJson(d),
    'updateAnimatedEmojiMessageClicked': (d) => UpdateAnimatedEmojiMessageClicked.fromJson(d),
