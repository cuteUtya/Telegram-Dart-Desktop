...
class PaymentFormTheme extends TdObject {
  ...
  PaymentFormTheme.fromJson(Map<String, dynamic> json)  {
    ...
    hintColor = json['hint_color'] == null ? null : json['hint_color'];
    linkColor = json['link_color'] == null ? null : json['link_color'];
    buttonColor = json['button_color'] == null ? null : json['button_color'];
    buttonTextColor = json['button_text_color'] == null ? null : json['button_text_color'];
  }
