...
class ChatStatisticsSupergroup extends ChatStatistics {
  ...
  ChatStatisticsSupergroup.fromJson(Map<String, dynamic> json)  {
    ...
    memberCount = StatisticalValue.fromJson(json['member_count'] ?? <String, dynamic>{});
    messageCount = StatisticalValue.fromJson(json['message_count'] ?? <String, dynamic>{});
    viewerCount = StatisticalValue.fromJson(json['viewer_count'] ?? <String, dynamic>{});
    senderCount = StatisticalValue.fromJson(json['sender_count'] ?? <String, dynamic>{});
    memberCountGraph = StatisticalGraph.fromJson(json['member_count_graph'] ?? <String, dynamic>{});
    joinGraph = StatisticalGraph.fromJson(json['join_graph'] ?? <String, dynamic>{});
    joinBySourceGraph = StatisticalGraph.fromJson(json['join_by_source_graph'] ?? <String, dynamic>{});
    languageGraph = StatisticalGraph.fromJson(json['language_graph'] ?? <String, dynamic>{});
    messageContentGraph = StatisticalGraph.fromJson(json['message_content_graph'] ?? <String, dynamic>{});
    actionGraph = StatisticalGraph.fromJson(json['action_graph'] ?? <String, dynamic>{});
    dayGraph = StatisticalGraph.fromJson(json['day_graph'] ?? <String, dynamic>{});
    weekGraph = StatisticalGraph.fromJson(json['week_graph'] ?? <String, dynamic>{});
    topSenders = List<ChatStatisticsMessageSenderInfo>.from((json['top_senders'] ?? [])!.map((item) => ChatStatisticsMessageSenderInfo.fromJson(item ?? <String, dynamic>{})).toList());
    topAdministrators = List<ChatStatisticsAdministratorActionsInfo>.from((json['top_administrators'] ?? [])!.map((item) => ChatStatisticsAdministratorActionsInfo.fromJson(item ?? <String, dynamic>{})).toList());
    topInviters = List<ChatStatisticsInviterInfo>.from((json['top_inviters'] ?? [])!.map((item) => ChatStatisticsInviterInfo.fromJson(item ?? <String, dynamic>{})).toList());
    extra = json['@extra'];
  }
...
class ChatStatisticsChannel extends ChatStatistics {
  ...
  ChatStatisticsChannel.fromJson(Map<String, dynamic> json)  {
    period = DateRange.fromJson(json['period'] ?? <String, dynamic>{});
    memberCount = StatisticalValue.fromJson(json['member_count'] ?? <String, dynamic>{});
    meanViewCount = StatisticalValue.fromJson(json['mean_view_count'] ?? <String, dynamic>{});
    meanShareCount = StatisticalValue.fromJson(json['mean_share_count'] ?? <String, dynamic>{});
    enabledNotificationsPercentage = json['enabled_notifications_percentage'];
    memberCountGraph = StatisticalGraph.fromJson(json['member_count_graph'] ?? <String, dynamic>{});
    joinGraph = StatisticalGraph.fromJson(json['join_graph'] ?? <String, dynamic>{});
    muteGraph = StatisticalGraph.fromJson(json['mute_graph'] ?? <String, dynamic>{});
    viewCountByHourGraph = StatisticalGraph.fromJson(json['view_count_by_hour_graph'] ?? <String, dynamic>{});
    viewCountBySourceGraph = StatisticalGraph.fromJson(json['view_count_by_source_graph'] ?? <String, dynamic>{});
    joinBySourceGraph = StatisticalGraph.fromJson(json['join_by_source_graph'] ?? <String, dynamic>{});
    languageGraph = StatisticalGraph.fromJson(json['language_graph'] ?? <String, dynamic>{});
    messageInteractionGraph = StatisticalGraph.fromJson(json['message_interaction_graph'] ?? <String, dynamic>{});
    instantViewInteractionGraph = StatisticalGraph.fromJson(json['instant_view_interaction_graph'] ?? <String, dynamic>{});
    recentMessageInteractions = List<ChatStatisticsMessageInteractionInfo>.from((json['recent_message_interactions'] ?? [])!.map((item) => ChatStatisticsMessageInteractionInfo.fromJson(item ?? <String, dynamic>{})).toList());
    extra = json['@extra'];
  }
