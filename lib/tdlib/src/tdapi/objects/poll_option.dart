...
class PollOption extends TdObject {
  ...
  PollOption.fromJson(Map<String, dynamic> json)  {
    ...
    voterCount = json['voter_count'] == null ? null : json['voter_count'];
    votePercentage = json['vote_percentage'] == null ? null : json['vote_percentage'];
    isChosen = json['is_chosen'] == null ? null : json['is_chosen'];
    isBeingChosen = json['is_being_chosen'] == null ? null : json['is_being_chosen'];
  }
