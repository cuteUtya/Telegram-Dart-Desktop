...
class RemoteFile extends TdObject {
  ...
  RemoteFile.fromJson(Map<String, dynamic> json)  {
    ...
    isUploadingActive = json['is_uploading_active'] == null ? null : json['is_uploading_active'];
    isUploadingCompleted = json['is_uploading_completed'] == null ? null : json['is_uploading_completed'];
    uploadedSize = json['uploaded_size'] == null ? null : json['uploaded_size'];
  }
