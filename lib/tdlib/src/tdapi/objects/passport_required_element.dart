...
class PassportRequiredElement extends TdObject {
  ...
  PassportRequiredElement.fromJson(Map<String, dynamic> json)  {
    suitableElements = json['suitable_elements'] == null ? null : List<PassportSuitableElement>.from((json['suitable_elements'] ?? [])!.map((item) => PassportSuitableElement.fromJson(item ?? <String, dynamic>{})).toList());
  }
