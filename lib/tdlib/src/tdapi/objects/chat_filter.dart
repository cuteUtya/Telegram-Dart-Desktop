...
class ChatFilter extends TdObject {
  ...
  ChatFilter.fromJson(Map<String, dynamic> json)  {
    ...
    pinnedChatIds = json['pinned_chat_ids'] == null ? null : List<int>.from((json['pinned_chat_ids'] ?? [])!.map((item) => item).toList());
    includedChatIds = json['included_chat_ids'] == null ? null : List<int>.from((json['included_chat_ids'] ?? [])!.map((item) => item).toList());
    excludedChatIds = json['excluded_chat_ids'] == null ? null : List<int>.from((json['excluded_chat_ids'] ?? [])!.map((item) => item).toList());
    excludeMuted = json['exclude_muted'] == null ? null : json['exclude_muted'];
    excludeRead = json['exclude_read'] == null ? null : json['exclude_read'];
    excludeArchived = json['exclude_archived'] == null ? null : json['exclude_archived'];
    includeContacts = json['include_contacts'] == null ? null : json['include_contacts'];
    includeNonContacts = json['include_non_contacts'] == null ? null : json['include_non_contacts'];
    includeBots = json['include_bots'] == null ? null : json['include_bots'];
    includeGroups = json['include_groups'] == null ? null : json['include_groups'];
    includeChannels = json['include_channels'] == null ? null : json['include_channels'];
    extra = json['@extra'];
  }
