...
class PaymentsProviderStripe extends TdObject {
  ...
  PaymentsProviderStripe.fromJson(Map<String, dynamic> json)  {
    publishableKey = json['publishable_key'] == null ? null : json['publishable_key'];
    needCountry = json['need_country'] == null ? null : json['need_country'];
    needPostalCode = json['need_postal_code'] == null ? null : json['need_postal_code'];
    needCardholderName = json['need_cardholder_name'] == null ? null : json['need_cardholder_name'];
  }
